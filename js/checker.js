...
// 문체 지문용 간단 반말 종결 패턴입니다.
// 존댓말 패턴과 겹치기 쉬운 '이다/있다/없다' 같은 중립형은 빼고,
// 비교적 말맛이 뚜렷한 반말 어미만 좁게 잡습니다.
const INFORMAL_ENDING_PATTERN = /(?:했다|한다|해|하네|더라|하자|가자|보자|하지|좋아|좋네|갔다|왔다|봤다|먹었다|썼다)(?:[.!?\s]|$)/g;
